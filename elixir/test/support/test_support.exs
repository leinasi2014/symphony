defmodule SymphonyElixir.TestSupport do
    ...
    quote do
      ...
      setup do
        ...
        on_exit(fn ->
          ...
          Application.delete_env(:symphony_elixir, :memory_tracker_comment_result)
          Application.delete_env(:symphony_elixir, :memory_tracker_state_update_result)
  ...
  defp workflow_content(overrides) do
    ...
    agent_guardrails = Keyword.get(config, :agent_guardrails)
    ...
    sections =
      [
        ...
        agent_guardrails && "  guardrails: #{yaml_value(agent_guardrails)}",
        "codex:",
